...
import { addUndoQueue, pageState, setExpressionState } from "state";
...
export const MQ_FIELD = MQ.MathField(UIElements.mqInput, {
    ...
    handlers: {
        edit: () => {MQ_FIELD.latex() !== pageState.equation && fieldEdit()}
    }
});
...
function fieldEdit() {
    ...
    manageVariables();
    pageState.equation = MQ_FIELD.latex();
    addUndoQueue();
